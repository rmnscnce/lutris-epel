...
%global commit %(curl -s https://api.github.com/repos/lutris/lutris/commits |grep sha |cut -d'"' -f 4 |head -n 1)
%global shortcommit %(commit=%{commit}; echo ${commit:0:7})
Name:           lutris-unstable
...
Source0:        https://codeload.github.com/lutris/lutris/tar.gz/%{commit}
...
%install
%py3_install
mv %{buildroot}/%{_datadir}/metainfo/net.lutris.Lutris.metainfo.xml %{buildroot}/%{_datadir}/metainfo/net.%{name}.Lutris.metainfo.xml
appstream-util validate-relax --nonet %{buildroot}/%{_datadir}/metainfo/net.%{name}.Lutris.metainfo.xml

%fdupes %{buildroot}%{python3_sitelib}

mv share/applications/net.lutris.Lutris.desktop share/applications/net.%{name}.Lutris.desktop
desktop-file-install --dir=%{buildroot}%{_datadir}/applications share/applications/net.%{name}.Lutris.desktop

mv %{buildroot}%{_bindir}/lutris %{buildroot}%{_bindir}/%{name}
mv %{buildroot}/%{_datadir}/lutris/ %{buildroot}/%{_datadir}/%{name}/
mv %{buildroot}/%{_datadir}/applications/net.lutris.Lutris.desktop %{buildroot}/%{_datadir}/applications/net.%{name}.Lutris.desktop
mv %{buildroot}/%{_datadir}/icons/hicolor/scalable/apps/lutris.svg %{buildroot}/%{_datadir}/icons/hicolor/scalable/apps/%{name}.svg
mv %{buildroot}/%{_datadir}/icons/hicolor/16x16/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/16x16/apps/%{name}.png
mv %{buildroot}/%{_datadir}/icons/hicolor/22x22/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/22x22/apps/%{name}.png
mv %{buildroot}/%{_datadir}/icons/hicolor/24x24/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/24x24/apps/%{name}.png
mv %{buildroot}/%{_datadir}/icons/hicolor/32x32/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/32x32/apps/%{name}.png
mv %{buildroot}/%{_datadir}/icons/hicolor/48x48/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/48x48/apps/%{name}.png
mv %{buildroot}/%{_datadir}/icons/hicolor/64x64/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/64x64/apps/%{name}.png
mv %{buildroot}/%{_datadir}/icons/hicolor/128x128/apps/lutris.png %{buildroot}/%{_datadir}/icons/hicolor/128x128/apps/%{name}.png
mv %{buildroot}/%{_datadir}/man/man1/lutris.1 %{buildroot}/%{_datadir}/man/man1/%{name}.1
mv %{buildroot}%{python3_sitelib}/lutris-*.egg-info %{buildroot}%{python3_sitelib}/%{name}-*.egg-info
mv %{buildroot}%{python3_sitelib}/lutris/ %{buildroot}%{python3_sitelib}/%{name}/
